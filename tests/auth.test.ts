...
describe('Authentication', () => {
  describe('JWT Token Generation', () => {
    test('should generate valid access token with proper claims', async () => {
      ...
      const token = await signJwt(env as any, {
        sub: 'did:plc:test123',
  ...
  describe('Token Verification', () => {
    ...
    test('should reject tokens with wrong secret', async () => {
      ...
      const token = await signJwt(env1 as any, {
        sub: 'did:plc:test123',
        t: 'access',
      }, 'access');
  ...
  describe('Token Rotation', () => {
    test('should generate new JTI on rotation', async () => {
      ...
      const token1 = await signJwt(env as any, {
        sub: 'did:plc:test123',
        t: 'refresh',
        jti: jti1,
      }, 'refresh');
      ...
      const token2 = await signJwt(env as any, {
        sub: 'did:plc:test123',
        t: 'refresh',
        jti: jti2,
      }, 'refresh');
  ...
  describe('Token Cleanup', () => {
    ...
    test('should run lazy cleanup probabilistically', async () => {
      const { lazyCleanupExpiredTokens } = await import('../src/lib/token-cleanup');
