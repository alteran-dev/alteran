...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      REFRESH_TOKEN_SECRET: envField.string({ context: 'server', access: 'secret' }),
      ...
      PDS_HOSTNAME: envField.string({ context: 'server', access: 'secret', optional: true }),
      PDS_ACCESS_TTL_SEC: envField.string({ context: 'server', access: 'secret', optional: true }),
      PDS_REFRESH_TTL_SEC: envField.string({ context: 'server', access: 'secret', optional: true }),
      ...
      REPO_SIGNING_KEY: envField.string({ context: 'server', access: 'secret', optional: true }),
      REPO_SIGNING_PUBLIC_KEY: envField.string({ context: 'server', access: 'secret', optional: true }),
    },
  },
});
